    ...
    return (
        <div>
            <Head>
                ...
                <meta property="og:title" content="Praveen Thirumurugan - Blog articles" />
                <meta property="og:description" content="Praveen Thirumurugan - Blog articles" />
                <meta property="og:url" content={'https://www.praveent.com/posts/'} />
                <meta property="og:image" content="" />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Praveen Thirumurugan - Blog articles" />
                <meta name="twitter:description" content="Praveen Thirumurugan - Blog articles" />
                ...
                <title>Praveen Thirumurugan - Blog articles</title>
                                ...
                                <div className="grid grid-cols-12 gap-6">
                                    <Link href={`/post/${post.slug.current}`}>
                                        <div className="flex items-center justify-center col-span-12" style={{cursor: 'pointer'}}>
                                            <img className="rounded" width="100%" src={post.mainImage ? urlFor(post.mainImage).width(1920).url() : '/images/avatar_light.png' } alt={post ? post.title : 'Blog image failed to load'}/>
                                        </div>
                                    </Link>
                                    <div className="flex items-center col-span-12">
                                        <div>
                                            ...
                                            <div className="mt-6">
                                                ...
                                                <RWebShare data={{ text: post.title, url: 'https://praveent.com/post/' + post.slug.current, title: post.title, }}>
